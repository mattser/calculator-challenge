...
const calculator = {
  ...
  workingLine: document.querySelector("p").innerHTML,
  answerLine: document.querySelector("h1").innerHTML
}
...
const appendValueToWorkingLine = (valueToAppend) => {
  calculator.workingLine += valueToAppend;
}

const clearAll = () => {
  calculator.answerLine = "";
  calculator.workingLine = "";
  pushedNumber = 0;
  workingNumber = 0;
  globalOperator = "";
